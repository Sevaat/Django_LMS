...
DATABASES = {
    "default": {
        ...
        "PASSWORD": os.getenv("DATABASE_PASSWORD", "lms_password"),
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "API для платформы управления обучением с курсами, уроками и подписками",
    "VERSION": "1.0.0",
    ...
    "TAGS": [
        ...
        {"name": "Payments", "description": "Управление платежами"},
