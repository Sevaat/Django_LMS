...
class LessonTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.owner_user = User.objects.create_user(
            email="owner@test.com", password="testpass123", first_name="Owner", last_name="User"
        )

        self.moder_user = User.objects.create_user(
            email="moder@test.com", password="testpass123", first_name="Moder", last_name="User"
        )
        ...
        self.course = Course.objects.create(
            name="Test Course", description="Test Description", owner=self.regular_user
        )
...
class LessonValidationTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.lesson_data = {"name": "Test Lesson", "description": "Test Description", "course": self.course.id}
    ...
    def test_invalid_url_not_youtube(self):
        ...
        invalid_urls = ["https://vimeo.com/123456", "https://rutube.ru/video/123/", "https://example.com/video.mp4"]
